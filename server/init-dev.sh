#! /bin/bash
# Does not do anything at the moment but should handle env config initialization when it needed. Soon. First checks that the config folder can be found and the file given environment exists and then copies it to ?
